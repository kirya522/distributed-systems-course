...
//
// Code generated by github.com/lerenn/asyncapi-codegen version v0.46.3 DO NOT EDIT.
package events
...
type AppSubscriber interface {
	// PublishOrderCreated subscribes to messages placed on the 'orders.order-created' channel
	PublishOrderCreated(ctx context.Context, msg OrdersOrderCreatedMessage) error
}
...
func (c *AppController) SubscribeAll(ctx context.Context, as AppSubscriber) error {
	...
	if err := c.SubscribePublishOrderCreated(ctx, as.PublishOrderCreated); err != nil {
		return err
	}
...
func (c *AppController) UnsubscribeAll(ctx context.Context) {
	c.UnsubscribePublishOrderCreated(ctx)
}

// SubscribePublishOrderCreated will subscribe to new messages from 'orders.order-created' channel.
//
// Callback function 'fn' will be called each time a new message is received.
func (c *AppController) SubscribePublishOrderCreated(
	ctx context.Context,
	fn func(ctx context.Context, msg OrdersOrderCreatedMessage) error,
) error {
	// Get channel path
	...
	go func() {
		for {
			...
			stop, err := c.listenToPublishOrderCreatedNextMessage(path, sub, fn)
			if err != nil {
				c.logger.Error(ctx, err.Error())
			}
...
func (c *AppController) listenToPublishOrderCreatedNextMessage(
	path string,
	...
	if err := c.executeMiddlewares(msgCtx, &acknowledgeableBrokerMessage.BrokerMessage, func(middlewareCtx context.Context) error {
		// Process message
		msg, err := brokerMessageToOrdersOrderCreatedMessage(acknowledgeableBrokerMessage.BrokerMessage)
		if err != nil {
			return err
		}
...
// UnsubscribePublishOrderCreated will unsubscribe messages from 'orders.order-created' channel.
// A timeout can be set in context to avoid blocking operation, if needed.
func (c *AppController) UnsubscribePublishOrderCreated(ctx context.Context) {
	// Get channel path
	path := "orders.order-created"
...
// PublishPublishOrderCreated will publish messages to 'orders.order-created' channel
func (c *UserController) PublishPublishOrderCreated(
	ctx context.Context,
	msg OrdersOrderCreatedMessage,
) error {
	// Get channel path
	path := "orders.order-created"
...
// OrdersOrderCreatedMessage is the message expected for 'OrdersOrderCreatedMessage' channel.
type OrdersOrderCreatedMessage struct {
	// Payload will be inserted in the message payload
	Payload OrderCreatedSchema
}

func NewOrdersOrderCreatedMessage() OrdersOrderCreatedMessage {
	var msg OrdersOrderCreatedMessage

	return msg
}

// brokerMessageToOrdersOrderCreatedMessage will fill a new OrdersOrderCreatedMessage with data from generic broker message
func brokerMessageToOrdersOrderCreatedMessage(bMsg extensions.BrokerMessage) (OrdersOrderCreatedMessage, error) {
	var msg OrdersOrderCreatedMessage
...
// toBrokerMessage will generate a generic broker message from OrdersOrderCreatedMessage data
func (msg OrdersOrderCreatedMessage) toBrokerMessage() (extensions.BrokerMessage, error) {
...
// OrderCreatedSchema is a schema from the AsyncAPI specification required in messages
type OrderCreatedSchema struct {
...
const (
	// OrdersOrderCreatedPath is the constant representing the 'OrdersOrderCreated' channel path.
	OrdersOrderCreatedPath = "orders.order-created"
)

// ChannelsPaths is an array of all channels paths
var ChannelsPaths = []string{
	OrdersOrderCreatedPath,
}
